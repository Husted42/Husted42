...
Der må være noget mønster i den lodrette variation
  ...
  *  Punkterne udgør en slags trag, viser at spredningen stiger med middelværdien hvilket er et tegn på varianshomogenitet.
...
# Generalt
## Beregning af sandsyligheder pbinorm
TODO : Skriv afsnit, inkluder at man ikke tager f.eks 10 med en værdi mellem 15 og 10 = P(X<= 15) - P(X<=9)
## Fejltyper
