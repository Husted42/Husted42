...
**Fortolkning:** På baggrund af stikprøven fås et 95 % - konfidensinterval på (6.98; 8.33) cm. Vores vurdering er, at dette interval med 95 %  sandsynlighed vil omfatte den sande (men ukendte) værdi af middelværdien i hele populationen. På baggrund af stikprøven virkder det således som om, at studerende på StatData1 2024/25 i gennemsnit afsætter punkterne i den korrekte afstand på 8.0 cm. 
...
* Man skal holde tungen lige i munden mht. fortolkn ingen af middelværdiparameteren $\gamma$. Det er altså populationsmiddelværdien for logaritmen til antal gæt. Vi bruger også ordet _den forventede værdi_ (expected value) for log(gæt) og skriver
$$
