...
`dbt` · `Machine Learning` · `Deep Learning` · `Time Series` · `Forecasting` · `Statistical Modelling`
...
`dbt` · `Airbyte` · `Prefect` · `Azure Data Factory` · `ETL / ELT` · `Data Warehousing`
...
- Building data products with Python, SQL and modern web technologies
